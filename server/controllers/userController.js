...
const get_user = async (req, res) => {
    signup_template_copy
        .findOne({ email_id: requestAnimationFrame.params.id })
        .then((data) => {
            if (data === null)
...
const add_user = async (request, response, next) => {
    const { fullName, email_id, contact, position, password, attendence } =
        request.body;
    ...
    await signup_template_copy
        ...
        .then((userExist) => {
            ...
            const user = new signup_template_copy({
                fullName,
                email_id,
                contact,
                position,
            ...
            user.save()
                .then((res) => {
                    ...
                    const newAttendees = new attendance_template_copy({
                        user_id: res["_id"],
...
const login = async (request, response, next) => {
    try {
        ...
        const userLogin = await signup_template_copy.findOne({
            email_id: email_id,
        });
...
const update_user = async (request, response, next) => {
    ...
    signup_template_copy
        .findOneAndUpdate({ email_id: email_id }, { $set: updatedData })
        .then((data) => {
