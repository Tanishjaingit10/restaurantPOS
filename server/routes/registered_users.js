...
router.get('/orderBySession/:id', orderController.getOrderBySessionId)
...
router.get('/getReservationByTime/:date/:start_time/:end_time/:item_id?', reservationController.get_reservation_by_time)
...
router.get('/table/:number', tableController.single_table)
