...
const Loader = () => {
    return (
        <div
            className="py-12 flex justify-center absolute"
...
const Dashboard = () => {
    ...
    const [stopSalesDate, setStopSalesDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [startOrdersDate, setStartOrdersDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [stopOrdersDate, setStopOrdersDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [startCustomersDate, setStartCustomersDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [stopCustomersDate, setStopCustomersDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [startReservationsDate, setStartReservationsDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
    const [stopReservationsDate, setStopReservationsDate] = useState(
        new Date().toLocaleDateString("pt-br").split("/").reverse().join("-")
    );
        ...
        <div className="px-8">
            <div className="flex flex-row justify-between">
                <div className="flex flex-row" style={{ width: "48%" }}>
                    <CustomChart
                        title="Sales"
                        icon={<FaChartBar size={25} color="white" />}
                    >
                        <div
                        ...
                        >
                            ...
                            >
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Sales", "Total");
                                    }}
                                >
                                    Total Sales
                                </button>
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Sales", "Dine In");
                                    }}
                                >
                                    Dine In
                                </button>
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Sales", "Take Away");
                                    }}
                                >
                                    Take away
                                </button>
                ...
                <div className="" style={{ width: "48%" }}>
                    <CustomChart
                        title="Orders"
                        icon={<FaClipboardList color="white" size={25} />}
                    >
                        <div
                            className="flex flex-row justify-between"
                            style={{ width: "100%" }}
                        >
                            ...
                            >
                                ...
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Orders", "Dine In");
                                    }}
                                >
                                    Dine In
                                </button>
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Orders", "Take Away");
                                    }}
                                >
                                    Take away
                                </button>
                        ...
                        >
                            ...
                            >
                                <button
                                    className="home_chart_btn"
                                    onClick={() => {
                                        getDashboardData("Customers", "Total");
                                    }}
                                >
                                    Total Sales
                                </button>
