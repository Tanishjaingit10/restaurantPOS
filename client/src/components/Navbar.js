		...
		<ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
			...
			<li className="flex-1 md:flex-none md:mr-3">
				<div className="relative inline-block">
					<button onClick={openDrop} className="drop-button text-white hover:text-gray-200 hover:text-underline focus:outline-none"> <span className="pr-2"><i className="em em-robot_face"></i></span> Hi, User <svg className="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
