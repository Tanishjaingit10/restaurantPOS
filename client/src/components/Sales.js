      ...
      <div className="flex flex-col w-full">
				<div className="my-2 overflow-x-auto">
					...
					<div className="flex items-center justify-between my-5">
						<h2 className="font-bold text-2xl text-gray-600">Sales Report</h2>
            ...
            <div  ref={printTable}>
             <CustomTable>
              ...
              <div className="flex justify-end">
                <h5 className="text-xl font-semibold px-32 rounded py-4 text-white" style={{backgroundColor: theme.backgroundColor}}>Total: ${totalSales}</h5>
            </div>
					</div>
					<div className="flex flex-row items-end justify-between mb-4">
						<div>
						<div className="text-base text-gray-500 font-semibold">Total Card Payments: {cardPayment}</div>
						<div className="text-base text-gray-500 font-semibold">Total Online Payments: {onlinePayment}</div>
						<div className="text-base text-gray-500 font-semibold">Total Cash Payments: {cashPayment}</div>
						</div>
