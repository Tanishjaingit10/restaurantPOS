            ...
            <div className="bg-white w-full h-screen top-0">
                <nav className="bg-green lg:py-4 xl:py-6 px-1 mt-0 h-auto w-full top-0 text-2xl">
                    <div className="flex flex-wrap items-center">
                        <div className="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white ml-4"><Link to="/tables"><i className="fas fa-arrow-left mr-4"></i>Back</Link></div>
