        ...
        <div>
            <nav className="bg-gray-400 py-6 px-1 mt-0 h-auto w-full top-0 text-2xl">
                <div className="flex flex-wrap items-center">
                    <div className="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white ml-4"><Link to="/pos"><i className="fas fa-arrow-left mr-4"></i>Back</Link></div>
            ...
            <div className="flex flex-col p-8">
                <div className="flex flex-col p-6 w-96 mx-auto font-roboto">
                    ...
                    <div className="flex flex-col mt-8 space-y-4">
                        <button className="bg-green text-center text-white text-xl py-4 font-semibold font-roboto"><Link to="receipt">Print Receipt</Link></button>
                        <button className="bg-green text-center text-white text-xl py-4 font-semibold font-roboto"><Link to="receipt">Email Receipt</Link></button>
