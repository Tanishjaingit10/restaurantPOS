    ...
    <div className="h-screen justify-items-conter">
      ...
      <div className="flex flex-col p-8">
        <div className="flex flex-col p-6 w-96 mx-auto font-roboto">
          ...
          <div className="text-center mt-2 text-3xl text-primary">
            ${payment.total}
          </div>
        </div>
        <div className="w-1/3 mx-auto flex flex-col shadow-2xl">
          <div className="bg-white relative py-4 px-2 font-roboto">
            <p>Amount tendered</p>
            <span className="absolute top-2 right-2 text-4xl font-bold">
              ${cal}
              <i
                onClick={() => {
                  setCal(0);
                }}
                className="far fa-times-circle ml-2 text-2xl cursor-pointer"
              ></i>
            </span>
          </div>
          <div className="bg-gray-300 justify-evenly flex flex-row text-3xl py-2 text-primary font-semibold">
          ...
          <div className="grid grid-cols-3 bg-white font-roboto font-semibold text-2xl">
            ...
            <div className="text-center border-2 py-2">
              <i
                onClick={() => {
                  calculate(12);
                }}
                className="fas fa-backspace cursor-pointer"
              ></i>
            </div>
          </div>
        </div>
        <button
          className="w-96 bg-green mt-10 mx-auto py-4 text-white text-center text-2xl font-roboto font-bold"
          onClick={placeOrder}
        >
          Proceed
        </button>
